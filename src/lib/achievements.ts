...
export const achievements: Achievement[] = [
  ...
  { id: "self-aware", title: "SELF-AWARE", desc: "Studied yourself the way Cogniflow studies engagement." },
  { id: "full-restoration", title: "FULL RESTORATION", desc: "Caught every lost thought before the mind let go." },
  { id: "quick-mind", title: "QUICK MIND", desc: "Caught 10 thoughts before three got away." },
